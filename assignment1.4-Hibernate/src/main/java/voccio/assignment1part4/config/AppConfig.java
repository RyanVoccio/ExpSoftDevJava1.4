package voccio.assignment1part4.config;
 ...
 * Vitaly Yurik. Configured MySQL Data source. 
 */
@Configuration
@PropertySource("classpath:db/jdbc.properties")
@ComponentScan(basePackages = "voccio.assignment1part4")
...
public class AppConfig {
	...
	private Properties hibernateProperties() {
		...
		hibernateProp.put("hibernate.show_sql", false); //good for debugging
	...
	@Bean public SessionFactory sessionFactory() throws IOException {
		...
		sessionFactoryBean.setPackagesToScan("voccio.assignment1part4.entities");
